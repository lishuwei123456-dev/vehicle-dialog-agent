...
该仓库根据毕业设计项目和 demo 材料重建，聚焦“基于 LLM 驱动的车载智能语音助手设计与实现”。系统面向智能座舱高频任务，覆盖导航、天气、音乐和车辆控制等场景，并将本地语义模型、Function Calling、工具注册和会话状态管理组织成可运行的工程链路。
...
- 多轮上下文：支持内存状态存储和 Redis 部署，可补全“那里天气怎么样”“再调高一点”等省略表达。
...
```bash
curl http://127.0.0.1:8080/v1/evaluation/reported-metrics
```
